...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "2.5.1"
  WORKING_DIRECTORY "D:/GitHub/Giera_v1/cmake-build-debug-event-trace/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/GitHub/Giera_v1/cmake-build-debug-event-trace/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/GitHub/Giera_v1/cmake-build-debug-event-trace/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
